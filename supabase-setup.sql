...
drop policy if exists "Anyone can read play one invites" on public.play_one_invites;
...
drop policy if exists "Anyone can delete play one invites" on public.play_one_invites;
